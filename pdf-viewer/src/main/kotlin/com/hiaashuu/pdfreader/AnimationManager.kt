...
internal class AnimationManager(private val pdfView: PDFView) {
    ...
    internal inner class XAnimation : AnimatorListenerAdapter(), ValueAnimator.AnimatorUpdateListener {
    ...
    internal inner class YAnimation : AnimatorListenerAdapter(), ValueAnimator.AnimatorUpdateListener {
        override fun onAnimationUpdate(animation: ValueAnimator) {
            val offset = animation.animatedValue as Float
    ...
    internal inner class ZoomAnimation(private val centerX: Float, private val centerY: Float) : Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        override fun onAnimationUpdate(animation: ValueAnimator) {
